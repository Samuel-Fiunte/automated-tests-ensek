describe('Access register and test password no lower case error', () => {
  it('Password field should throw an error no lower case is used', () => {
    ...
    cy.xpath('/html/body/div[2]/form/div[1]/ul/li').should('be.visible').contains('Passwords must have at least one lowercase');
  });
});